...
export class Backend implements backendInterface {
    ...
    async getAllPayments(): Promise<Array<PaymentSubmission>> {
        if (this.processError) {
            try {
    ...
    async isAdminByDisplayName(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isAdminByDisplayName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PaymentSubmission_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentSubmission): Promise<PaymentSubmission> {
...
async function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PaymentSubmission]): Promise<PaymentSubmission | null> {
    return value.length === 0 ? null : await from_candid_PaymentSubmission_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        refundTimestamp: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.refundTimestamp)),
        screenshot: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.screenshot)
    };
}
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        refundPaymentQrCode: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.refundPaymentQrCode),
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PaymentSubmission>): Promise<Array<PaymentSubmission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PaymentSubmission_n11(_uploadFile, _downloadFile, x)));
}
