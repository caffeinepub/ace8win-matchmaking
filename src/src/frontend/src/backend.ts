...
import type { ExternalBlob as _ExternalBlob, Match as _Match, PaymentSubmission as _PaymentSubmission, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bookAllSlots(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bookAllSlots(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createMatch(arg0: string, arg1: string, arg2: number, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMatchDetails(arg0: string): Promise<Match | null> {
        if (this.processError) {
            try {
    ...
    async getMatchesByStatus(arg0: string): Promise<Array<Match>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMatchesByStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPaymentStatus(arg0: string): Promise<PaymentSubmission | null> {
        if (this.processError) {
            try {
    ...
    async getPendingPayments(): Promise<Array<PaymentSubmission>> {
        if (this.processError) {
            try {
    ...
    async getUserMatches(): Promise<Array<Match>> {
        if (this.processError) {
            try {
    ...
    async getUserTransactionHistory(): Promise<Array<PaymentSubmission>> {
        if (this.processError) {
            try {
    ...
    async markAsRefunded(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markAsRefunded(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectPayment(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitPayment(arg0: string, arg1: ExternalBlob, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPayment(arg0, await to_candid_ExternalBlob_n26(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserProfile(arg0: Principal, arg1: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserProfile(arg0, await to_candid_UserProfile_n24(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PaymentSubmission_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentSubmission): Promise<PaymentSubmission> {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Match]): Match | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PaymentSubmission]): Promise<PaymentSubmission | null> {
    return value.length === 0 ? null : await from_candid_PaymentSubmission_n19(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    refundPaymentQrCode: _ExternalBlob;
    displayName: string;
    email: string;
    gamePlayerId: string;
    gameName: string;
    ...
    return {
        refundPaymentQrCode: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.refundPaymentQrCode),
...
async function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        refundTimestamp: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.refundTimestamp)),
        screenshot: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.screenshot)
    };
}
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PaymentSubmission>): Promise<Array<PaymentSubmission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PaymentSubmission_n19(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        refundPaymentQrCode: await to_candid_ExternalBlob_n26(_uploadFile, _downloadFile, value.refundPaymentQrCode),
        displayName: value.displayName,
        email: value.email,
        gamePlayerId: value.gamePlayerId,
        gameName: value.gameName,
